...
#include </Users/yujie.zhao/works/Qt/Qt/Src/qtbase/src/corelib/text/qstringalgorithms.h>
...
//        REGISTER_OBJECT_INVOKE_METHOD(qCompressionZeroTermination);
        ...
        REGISTER_OBJECT_INVOKE_METHOD(remove_data);
        REGISTER_OBJECT_INVOKE_METHOD(remove);
        REGISTER_OBJECT_INVOKE_METHOD(remove_If);
        REGISTER_OBJECT_INVOKE_METHOD(replace_data);
        REGISTER_OBJECT_INVOKE_METHOD(replace);
        REGISTER_OBJECT_INVOKE_METHOD(replaceWithSpecifiedLength);
        ...
        REGISTER_OBJECT_INVOKE_METHOD(toLongLong_data);
        REGISTER_OBJECT_INVOKE_METHOD(toLongLong);
        REGISTER_OBJECT_INVOKE_METHOD(toULongLong_data);
        REGISTER_OBJECT_INVOKE_METHOD(toULongLong);
        REGISTER_OBJECT_INVOKE_METHOD(number);
        REGISTER_OBJECT_INVOKE_METHOD(number_base_data);
        REGISTER_OBJECT_INVOKE_METHOD(number_base);
        REGISTER_OBJECT_INVOKE_METHOD(toShort);
        REGISTER_OBJECT_INVOKE_METHOD(toUShort);
        REGISTER_OBJECT_INVOKE_METHOD(toInt_data);
        REGISTER_OBJECT_INVOKE_METHOD(toInt);
        REGISTER_OBJECT_INVOKE_METHOD(toUInt_data);
        ...
        REGISTER_OBJECT_INVOKE_METHOD(blockSizeCalculations);
        REGISTER_OBJECT_INVOKE_METHOD(resizeAfterFromRawData);
        REGISTER_OBJECT_INVOKE_METHOD(appendAfterFromRawData);
        REGISTER_OBJECT_INVOKE_METHOD(toFromHex_data);
        REGISTER_OBJECT_INVOKE_METHOD(toFromHex);
        REGISTER_OBJECT_INVOKE_METHOD(toFromPercentEncoding);
        REGISTER_OBJECT_INVOKE_METHOD(fromPercentEncoding);
        REGISTER_OBJECT_INVOKE_METHOD(fromPercentEncoding_data);
        REGISTER_OBJECT_INVOKE_METHOD(toPercentEncoding_data);
        REGISTER_OBJECT_INVOKE_METHOD(toPercentEncoding);
        REGISTER_OBJECT_INVOKE_METHOD(toPercentEncoding2_data);
        REGISTER_OBJECT_INVOKE_METHOD(toPercentEncoding2);
        REGISTER_OBJECT_INVOKE_METHOD(qstrcmp_data);
        REGISTER_OBJECT_INVOKE_METHOD(qstrcmp);
        REGISTER_OBJECT_INVOKE_METHOD(compare_singular);
        REGISTER_OBJECT_INVOKE_METHOD(compareCharStar_data);
        REGISTER_OBJECT_INVOKE_METHOD(compareCharStar);
        REGISTER_OBJECT_INVOKE_METHOD(repeatedSignature);
        REGISTER_OBJECT_INVOKE_METHOD(repeated_data);
        REGISTER_OBJECT_INVOKE_METHOD(repeated);
        REGISTER_OBJECT_INVOKE_METHOD(byteRefDetaching);
        REGISTER_OBJECT_INVOKE_METHOD(reserve);
        REGISTER_OBJECT_INVOKE_METHOD(reserveExtended_data);
        REGISTER_OBJECT_INVOKE_METHOD(reserveExtended);
        REGISTER_OBJECT_INVOKE_METHOD(movablity_data);
        REGISTER_OBJECT_INVOKE_METHOD(movablity);
        REGISTER_OBJECT_INVOKE_METHOD(literals);
        REGISTER_OBJECT_INVOKE_METHOD(userDefinedLiterals);
        REGISTER_OBJECT_INVOKE_METHOD(toUpperLower_data);
        REGISTER_OBJECT_INVOKE_METHOD(toUpperLower);
        REGISTER_OBJECT_INVOKE_METHOD(isUpper);
        REGISTER_OBJECT_INVOKE_METHOD(isLower);
        REGISTER_OBJECT_INVOKE_METHOD(macTypes);
        REGISTER_OBJECT_INVOKE_METHOD(stdString);
        REGISTER_OBJECT_INVOKE_METHOD(emptyAndClear);
        REGISTER_OBJECT_INVOKE_METHOD(fill);
        REGISTER_OBJECT_INVOKE_METHOD(dataPointers);
        REGISTER_OBJECT_INVOKE_METHOD(truncate);
        REGISTER_OBJECT_INVOKE_METHOD(trimmed);
        REGISTER_OBJECT_INVOKE_METHOD(trimmed_data);
        ...
        REGISTER_OBJECT_INVOKE_METHOD(length);
        REGISTER_OBJECT_INVOKE_METHOD(length_data);
    }
...
//    void qCompressionZeroTermination() const;
    ...
    void repeatedSignature();
    void repeated() const;
    void repeated_data() const;

    void byteRefDetaching();
...
void tst_QByteArray::resizeAfterFromRawData()
{
    ...
    //raw数组的dataPointer为空，resize时会进行detach操作
    array.resize(5);
    QVERIFY(array.constData() != buffer.constData());
...
void tst_QByteArray::repeatedSignature()
{
    const QByteArray t1("12345");
    t1.repeated(7);
...
void tst_QByteArray::byteRefDetaching()
{
    //非const调用operator[]与data()会进行一次detach操作
    //raw字符串的DataPointer为空，会被detach
    {
        QByteArray str = "str";
        QByteArray copy = str;
        copy[0] = 'S';
...
{
    //QByteArrayLiteral相当于rawData，"abcd"存放在全局数据区域
    //str， tststr2, tststr3中的ptr指针地址是一样的
    QByteArray str(QByteArrayLiteral("abcd"));
    QByteArray tststr2(QByteArrayLiteral("abcd"));
    QByteArray tststr3(QByteArrayLiteral("abcd"));
...
{
    QByteArray tst1(" abc ");
    QByteArray tst2 = tst1.trimmed();
    auto tst3 = QByteArray(" abc ").trimmed();
...
{
    QByteArray tst1(" abc ");
    QByteArray tst2 = tst1.simplified();
    auto tst3 = QByteArray(" abc ").simplified();
