...
public:
    ...
    void registerInvokeMethods() override
    {
        ...
        REGISTER_OBJECT_INVOKE_METHOD(capacity)
        REGISTER_OBJECT_INVOKE_METHOD(reserve)
        REGISTER_OBJECT_INVOKE_METHOD(squeeze)
        REGISTER_OBJECT_INVOKE_METHOD(detach)
        REGISTER_OBJECT_INVOKE_METHOD(isDetached)
        ...
        REGISTER_OBJECT_INVOKE_METHOD(containsSet)
        REGISTER_OBJECT_INVOKE_METHOD(begin)
        REGISTER_OBJECT_INVOKE_METHOD(end)
        REGISTER_OBJECT_INVOKE_METHOD(insert)
        REGISTER_OBJECT_INVOKE_METHOD(insertConstructionCounted)
        REGISTER_OBJECT_INVOKE_METHOD(setOperations)
        REGISTER_OBJECT_INVOKE_METHOD(setOperationsOnEmptySet)
        REGISTER_OBJECT_INVOKE_METHOD(stlIterator)
        REGISTER_OBJECT_INVOKE_METHOD(stlMutableIterator)
        REGISTER_OBJECT_INVOKE_METHOD(javaIterator)
        REGISTER_OBJECT_INVOKE_METHOD(javaMutableIterator)
        REGISTER_OBJECT_INVOKE_METHOD(makeSureTheComfortFunctionsCompile)
        REGISTER_OBJECT_INVOKE_METHOD(initializerList)
        REGISTER_OBJECT_INVOKE_METHOD(qhash)
        REGISTER_OBJECT_INVOKE_METHOD(intersects)
        REGISTER_OBJECT_INVOKE_METHOD(find)
        REGISTER_OBJECT_INVOKE_METHOD(values)
    }
