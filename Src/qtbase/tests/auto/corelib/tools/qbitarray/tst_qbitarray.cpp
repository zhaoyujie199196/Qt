...
public:
    void registerInvokeMethods() override {
        REGISTER_OBJECT_INVOKE_METHOD(size_data);
        REGISTER_OBJECT_INVOKE_METHOD(size);
        REGISTER_OBJECT_INVOKE_METHOD(countBits_data)
        REGISTER_OBJECT_INVOKE_METHOD(countBits)
        REGISTER_OBJECT_INVOKE_METHOD(countBits2)
        REGISTER_OBJECT_INVOKE_METHOD(isEmpty)
        REGISTER_OBJECT_INVOKE_METHOD(swap)
        REGISTER_OBJECT_INVOKE_METHOD(fill)
        REGISTER_OBJECT_INVOKE_METHOD(toggleBit_data)
        REGISTER_OBJECT_INVOKE_METHOD(toggleBit)
        REGISTER_OBJECT_INVOKE_METHOD(operator_andeq_data)
        REGISTER_OBJECT_INVOKE_METHOD(operator_andeq)
        REGISTER_OBJECT_INVOKE_METHOD(operator_oreq_data)
        REGISTER_OBJECT_INVOKE_METHOD(operator_oreq)
        REGISTER_OBJECT_INVOKE_METHOD(operator_xoreq_data)
        REGISTER_OBJECT_INVOKE_METHOD(operator_xoreq)
        REGISTER_OBJECT_INVOKE_METHOD(operator_neg_data)
        REGISTER_OBJECT_INVOKE_METHOD(operator_neg)
        REGISTER_OBJECT_INVOKE_METHOD(datastream_data)
        REGISTER_OBJECT_INVOKE_METHOD(datastream)
        REGISTER_OBJECT_INVOKE_METHOD(invertOnNull)
        REGISTER_OBJECT_INVOKE_METHOD(operator_noteq_data)
        REGISTER_OBJECT_INVOKE_METHOD(operator_noteq)

        REGISTER_OBJECT_INVOKE_METHOD(resize)
        REGISTER_OBJECT_INVOKE_METHOD(fromBits_data)
        REGISTER_OBJECT_INVOKE_METHOD(fromBits)

        REGISTER_OBJECT_INVOKE_METHOD(toUInt32_data)
        REGISTER_OBJECT_INVOKE_METHOD(toUInt32)
    }
...
void tst_QBitArray::fromBits_data()
{
    ...
    auto add = [](const QByteArray &tag, const char *data) {
        QTest::newRow(tag) << QByteArray(data, (tag.size() + 7) / 8) << (int)tag.size()
