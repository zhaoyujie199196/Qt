...
public:
    ...
    void registerInvokeMethods() override
    {
        ...
        REGISTER_OBJECT_INVOKE_METHOD(scale)
        REGISTER_OBJECT_INVOKE_METHOD(expandedTo)
        REGISTER_OBJECT_INVOKE_METHOD(expandedTo_data)
        REGISTER_OBJECT_INVOKE_METHOD(boundedTo_data)
        REGISTER_OBJECT_INVOKE_METHOD(boundedTo)
        REGISTER_OBJECT_INVOKE_METHOD(grownOrShrunkBy_data)
        REGISTER_OBJECT_INVOKE_METHOD(grownOrShrunkBy)
        REGISTER_OBJECT_INVOKE_METHOD(transpose_data)
        REGISTER_OBJECT_INVOKE_METHOD(transpose)
