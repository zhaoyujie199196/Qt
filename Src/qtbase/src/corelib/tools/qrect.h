...
Q_CORE_EXPORT QDataStream &operator<<(QDataStream &s, const QRect &) { Q_ASSERT(false); return s; }
Q_CORE_EXPORT QDataStream &operator>>(QDataStream &s, QRect &) { Q_ASSERT(false); return s; }
...
Q_CORE_EXPORT QDebug operator<<(QDebug debug, const QRect &) { Q_ASSERT(false); return debug; }
...
Q_CORE_EXPORT QDataStream &operator<<(QDataStream & s, const QRectF &) { Q_ASSERT(false); return s; }
Q_CORE_EXPORT QDataStream &operator>>(QDataStream & s, QRectF &) { Q_ASSERT(false); return s; }
...
Q_CORE_EXPORT QDebug operator<<(QDebug debug, const QRectF &);
